...
public void searchSuburb(int method) throws Exception {
	...
	public void login(String user) throws Exception {
		...
		try{
			if(isPasswordChanged()){
				...
				type(xpath(ObjectReference.smokeUserNameLogin_xp), userName);
				waitForElementPresent(xpath(ObjectReference.smokePasswordLogin_xp));
				type(xpath(ObjectReference.smokePasswordLogin_xp), password);
				waitForElementPresent(xpath(ObjectReference.smokeBtnSubmitLogin_xp));
				click(xpath(ObjectReference.smokeBtnSubmitLogin_xp));
				waitForElementPresent(xpath(ObjectReference.smokeBtnMyAccount_xp));
			}
	...
	public void changePassword() throws Exception{
		try{
			...
			type(xpath(ObjectReference.smokeChangePassword_xp), alternatePassword);
			type(xpath(ObjectReference.smokeRePassword_xp), alternateRePassword);
	...
	public void checkHealth() throws Exception{
		try{
			...
			try{
				...
				fail("Checking S3 Bucket access Failed!");
			}
			...
			try{
				...
				pass("Checking Access to Payment Gateway OK!");
				
			}catch(AssertionError e){
				fail("Checking Access to Payment Gateway failed!");
			}
			...
			try{
				...
				pass("Checking Statistics API Connection OK!");
			}catch(AssertionError e){
			...
			pass("Checking HealthCheck Done!");
